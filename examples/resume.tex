...
\name{Haizhou}{Sun}
\position{Machine Learning Cloud Platform Engineer{\enskip\cdotp\enskip}Software Architect}
% \address{235, World Cup buk-ro, Mapo-gu, Seoul, 03936, Republic of Korea}

\mobile{(+86) 18510343050}
...
\quote{``Take big bites.Anything worth doing is worth overdoing."}
